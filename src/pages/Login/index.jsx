                ...
                <div className='card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10'>
                    ...
                    <form className='w-full !mt-5'>
                        <div className="form-group w-full !mb-5">
                            <TextField type="email " id="email" label="Email ID" name="name" variant="outlined" className='w-full' />
                        </div>
                        <div className="form-group w-full !mb-5 relative">
                            <TextField
                                type={isShowPassword === true ? 'text' : 'password'}
                                id="password" label="Password" variant="outlined" className='w-full' name='password' />
                        ...
                        <Button className='flex gap-3 w-full btn-lg !text-[#000] !bg-[#f1f1f1]'>
